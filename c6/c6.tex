...
\begin{proof}
    ...
    \[
        0 \too K/\mathfrak{m}K \overset{\alpha}{\too} \too F/\mathfrak{m}F \too M/\mathfrak{m}M \too 0
    \] 
    which is also split. Since $K \subseteq \mathfrak{m} R^m$, $K/\mathfrak{m}K = 0$, i.e. $K = 0$. By the fact that the sequence splits, $F \simeq M \oplus K$ which implies $F \simeq M$. 
\end{proof}
